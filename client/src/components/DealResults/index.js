...
export function ResultsDisplay(props) {
  return (
    <Row className="pb-3 pt-3">
      <Col className="full_Box" xs={{ size: 8, offset: 2 }}>
        ...
        <Row className="">
          <Col className="results pt-2 pb-2 border-dark border-top" xs={{ size: 10, offset: 1 }}>
            <h6 className="text-center mb-1">Monthly Payment</h6>
            <h4 className="result_value text-center mb-1">{props.financePayment}</h4>
          </Col>
        </Row>
        <Row className="">
          <Col className="results pt-1 pb-1 border-dark border-top" xs={{ size: 10, offset: 1 }}>
